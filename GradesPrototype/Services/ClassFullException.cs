...
namespace GradesPrototype.Services
{
    ...
    class ClassFullException : Exception
    {
        ...
        public ClassFullException (string message, string nameOfClass) : base (message)
        {
            _className = nameOfClass;
        }

        public ClassFullException (string message, string nameOfClass, Exception inner): base (message, inner)
        {
            _className = nameOfClass;
        }
